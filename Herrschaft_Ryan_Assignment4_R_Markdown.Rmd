...
#your output reported the correct percent (50.5), however you incorrectly reported below 55.05%
...
barplot1
#close to perfect, I would add a layer (two different colors) that distinguished between clusters who received bednets and those who didn't
...
#Good preamble and well written script. Good approach with preparing data before analysis; for question 7 your intermediate steps were nice, I would suggest using piping operators to reduce the amount of intermediate steps but this is a good start to get on your way there!